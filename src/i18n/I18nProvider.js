    ...
    home: {
      ...
      blockchain: {
        ...
        features: {
          ...
          fair: {
            title: '公平经济模型',
            desc: '70%黑洞销毁,项目方零预留,链上实时可查,保障代币分配公平性',
          },
        },
      ...
      advantages: {
        ...
        cards: {
          strategy: {
            title: '国家战略加持',
            desc: '全球主要经济体将低空经济列为未来产业重点扶持方向，政府政策倾斜与中央财政补贴，将持续赋能发展。',
          },
          technology: {
            title: '技术突破赋能',
        ...
        stages: {
          ...
          armor: {
            ...
            items: [
              ...
              'Stake and burn 95% of low-altitude coins, increase token value',
      ...
      advantages: {
        ...
        cards: {
          strategy: {
            ...
            desc: 'Major global economies list low-altitude economy as a key future industry for support, with government policy tilt and central fiscal subsidies continuing to empower development.',
          },
          technology: {
